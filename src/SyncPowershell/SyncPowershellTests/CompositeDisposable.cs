//https://raw.githubusercontent.com/dotnet/reactive/main/Rx.NET/Source/src/System.Reactive/Disposables/CompositeDisposable.cs
    ...
    public sealed class CompositeDisposable : ICollection<IDisposable>, IDisposable
    {
        ...
        private static List<IDisposable?> ToList(IEnumerable<IDisposable> disposables)
        {
            ...
            foreach (var d in disposables)
            {
                if (d == null)
                {
                    throw new ArgumentException("Disposables must exists", nameof(disposables));
                }
